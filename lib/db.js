...
// Initialize Prisma Client with proper configuration for Accelerate
...
export const db = {
  ...
  // Health check - simplified for Accelerate
  async healthCheck() {
    try {
      // Use a simple query instead of $queryRaw for Accelerate
